...
$(document).ready(function() {
        ...
        getRequest(
            ...
            function (res) {
                ...
                refundList.forEach(function (refundSchedule) {
                    $('#refund-method-input').append("<option value="+ refundSchedule.id +">"+refundSchedule.bestTime+"小时前退还"+refundSchedule.bestPercent+";  "+
                    refundSchedule.mediumTime+"小时前退还"+refundSchedule.mediumPercent+";"+
                    refundSchedule.badTime+"小时前退还"+refundSchedule.badPercent+"</option>");
                    $('#refund-edit-method-input').append("<option value="+ refundSchedule.id +">"+refundSchedule.bestTime+"小时前退还"+refundSchedule.bestPercent+";  "+
                    refundSchedule.mediumTime+"小时前退还"+refundSchedule.mediumPercent+";  "+
                    refundSchedule.badTime+"小时前退还"+refundSchedule.badPercent+"</option>");
                });
            },
    ...
    $('#schedule-form-btn').click(function () {
        var form = {
            ...
            refundSchedule: $("#refund-method-input").children('option:selected').val()
        };
        var isValidate = true;
        if (!form.hallId){
            isValidate = false;
        ...
        if (!form.refundSchedule){
            isValidate = false;
            $('#refund-method-input').parent('.form-group').addClass('has-error');
        }
    ...
    $('#schedule-edit-form-btn').click(function () {
        var form = {
            ...
            refundSchedule: $("#refund-edit-method-input").children('option:selected').val()
        };
        var isValidate = true;
        if (!form.hallId){
            isValidate = false;
        ...
        if (!form.refundSchedule){
            isValidate = false;
            $('#refund-edit-method-input').parent('.form-group').addClass('has-error');
        }
        if(!isValidate){return;}
