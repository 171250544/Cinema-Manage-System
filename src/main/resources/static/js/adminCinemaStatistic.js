$(document).ready(function() {
    var placingrateurl='/statistics/PlacingRate?date=';
    ...
    $('#getDate-btn').click(function () {

        placingrateurl=placingrateurl+$("#getDate").val().replace(/-/g,"/");
        getPlacingRate();
        placingrateurl='/statistics/PlacingRate?date=';
    ...
    function getPolularMovie() {
        // todo
        getRequest(
            '/statistics/popular/movie?days=1000&movieNum=3',
            function (res) {
                var data = res.content || [];
                var tableData = data.map(function (item) {
                    return item.boxOffice;
