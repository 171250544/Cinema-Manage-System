...
public class ScheduleServiceImpl implements ScheduleService, ScheduleServiceForBl {
    ...
    public ResponseVO addSchedule(ScheduleForm scheduleForm) {
        try {
            ...
            hallServiceForBl.insertUseTime(scheduleForm.getHallId(), scheduleForm.getEndTime());
            ScheduleItem scheduleItem = new ScheduleItem();
            scheduleItem.setId(scheduleForm.getId());
            scheduleItem.setEndTime(scheduleForm.getEndTime());
            scheduleItem.setFare(scheduleForm.getFare());
            scheduleItem.setHallId(scheduleForm.getHallId());
            scheduleItem.setMovieId(scheduleForm.getMovieId());
            scheduleItem.setStartTime(scheduleForm.getStartTime());
            scheduleItem.setRefundSchedule(scheduleForm.getRefundSchedule());
            scheduleMapper.insertOneSchedule(scheduleItem);
