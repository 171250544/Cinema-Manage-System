...
public class TicketController {
    ...
    @PostMapping("/vip/buy")
    public ResponseVO buyTicketByVIPCard(@RequestBody Map<String, Object> map){
        return ticketService.completeByVIPCard((List<Integer>)map.get("ticketId"),(Integer)map.get("couponId"));
    }
...
//    }
    ...
    @PostMapping("/buy")
    public ResponseVO buyTicket(@RequestBody Map<String, Object> map){
        return ticketService.completeTicket((List<Integer>)map.get("ticketId"),(Integer)map.get("couponId"));
    }
